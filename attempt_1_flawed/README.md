...
## The README of this first attempt before I found this flaw:
...
## Addendum: Places AI helped

I've been learning lots, and reading lots. This project is an attempt to DO. Still, AI has been incredibly helpful for review + exploration. Some things I might have missed if not for AI assistance:

- Accidentally left in a stop codon at the end of aeBlue
- An extra 'G' causing a frame shift
- Some accidental extra NcoI sites in the seqs I came up with
- The fact that aeBlue is a tetramer (missed by Sonnet 4.5, Opus 4.5, GPT 5.1 Thinking, Gemini 3 pro on first pass, caught by G3p on a last final review after some serious searching)

It was also just incredibly helpful being able to quiz AI to check my understanding throughout, and to have it write extra bits of code for things like double-checking sequences by translating back and comparing, or showing me the APIs for biopython stuff I haven't used before. Sonnet did get thrown by the 1-indexed snapgene outputs and in general struggled with tokenizing DNA, with a few nonsensical "[seq1] should be [seq1]" statements where it literally just spat out the same string two+ times and claimed they were different. IOW having a human thinking and in the drivers seat still helped :)